...
function(e) {
    ...
    t.prototype = {
        ...
        _initTemplateDefaults: function() {
            var t, a, r, n, o, l, s, d, c, p, u, f, m, g, v, h, w, _, b, C, y, E, x, T, S, F, I, P, k, z, A, $, D, U, j, L, R = this;
        ...
        _initPreviewCache: function() {
            ...
            t.previewCache = {
                ...
                footer: function(e, a, r) {
                    ...
                    c = i.ifSet("url", l, !1),
                    p = i.ifSet("key", l, null),
                    u = t.fileActionSettings,
                    f = t.initialPreviewShowDelete || !1,
                    m = i.ifSet("showDelete", l, i.ifSet("showDelete", u, f)),
                    g = i.ifSet("showZoom", l, i.ifSet("showZoom", u, !0)),
                    v = i.ifSet("showDrag", l, i.ifSet("showDrag", u, !0)),
                    h = c === !1 && a;
                    return o = t._renderFileActions(!1, m, g, v, h, c, p, !0),
                    t._getLayoutTemplate("footer").replace(/\{progress}/g, t._renderThumbProgress()).replace(/\{actions}/g, o).replace(/\{caption}/g, s).replace(/\{size}/g, t._getSize(r)).replace(/\{width}/g, d).replace(/\{indicator}/g, "")
                }
            },
            t.previewCache.init()
        },
        ...
        _getPreviewIcon: function(i) {
            var t, a = this,
            r = null;
            return i && i.indexOf(".") > -1 && (t = i.split(".").pop(), a.previewFileIconSettings && (r = a.previewFileIconSettings[t] || a.previewFileIconSettings[t.toLowerCase()] || null), a.previewFileExtSettings && e.each(a.previewFileExtSettings,
            function(e, i) {
        ...
        _initSuccessThumbs: function() {
            ...
            t.showPreview && t._getThumbs(i.FRAMES + ".file-preview-success").each(function() {
                ...
                function() {
                    var e = a.attr("id"),
                    n = t._raise("filesuccessremove", [e, a.attr("data-fileindex")]);
                    i.cleanMemory(a),
                    n !== !1 && a.fadeOut("slow",
                    function() {
                ...
                if (!i.isEmpty(l) && void 0 !== s) {
                    ...
                    d = e.extend(!0, {},
                    {
                        ...
                        success: function(e, r, l) {
                            var d, p;
                            return i.isEmpty(e) || i.isEmpty(e.error) ? (t.previewCache.init(), g = parseInt(f.attr("data-fileindex").replace("init_", "")), t.previewCache.unset(g), d = t.previewCache.count(), p = d > 0 ? t._getMsgSelected(d) : "", t._deleteFileIndex(f), t._setCaption(p), t._raise("filedeleted", [s, l, u]), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow",
                            function() {
        ...
        _readFiles: function(t) {
            ...
            a = function(e) {
                ...
                if (i.isEmpty(w) || (R = new RegExp("\\.(" + w.join("|") + ")$", "i")), T = L.toFixed(2), r.maxFileSize > 0 && L > r.maxFileSize) return F = r.msgSizeTooLarge.replace("{name}", j).replace("{size}", T).replace("{maxSize}", r.maxFileSize),
                void(r.isError = y(F, U, D, e));
                if (null !== r.minFileSize && L <= i.getNum(r.minFileSize)) return F = r.msgSizeTooSmall.replace("{name}", j).replace("{size}", T).replace("{minSize}", r.minFileSize),
                void(r.isError = y(F, U, D, e));
        ...
        _renderFileFooter: function(e, t, a, r) {
            ...
            m = o._getLayoutTemplate("actionIndicator"),
            g = r ? l.indicatorErrorTitle: l.indicatorNewTitle,
            v = m.replace(/\{indicator}/g, f).replace(/\{indicatorTitle}/g, g);
            return t = o._getSize(t),
            n = o.isUploadable ? u.replace(/\{actions}/g, o._renderFileActions(c, s, p, d, !1, !1, !1)).replace(/\{caption}/g, e).replace(/\{size}/g, t).replace(/\{width}/g, a).replace(/\{progress}/g, o._renderThumbProgress()).replace(/\{indicator}/g, v) : u.replace(/\{actions}/g, o._renderFileActions(!1, !1, p, d, !1, !1, !1)).replace(/\{caption}/g, e).replace(/\{size}/g, t).replace(/\{width}/g, a).replace(/\{progress}/g, "").replace(/\{indicator}/g, v),
