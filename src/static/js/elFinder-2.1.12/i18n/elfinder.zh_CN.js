...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.zh_CN = {
		...
		messages   : {
			...
			'cmdinfo'      : '查看信息',
			'cmdmkdir'     : '新建文件夹',
			'cmdmkdirin'   : '移入新建文件夹', // from v2.1.7 added 19.2.2016
			'cmdmkfile'    : '新建文本文件',
			'cmdopen'      : '打开',
			'cmdpaste'     : '粘贴',
			'cmdquicklook' : '预览',
			...
			'emptyFolder'     : '目录为空', // from v2.1.6 added 30.12.2015
			'emptyFolderDrop' : '目录为空', // from v2.1.6 added 30.12.2015
			'emptyFolderLTap' : '目录为空\\A Long tap to add items', // from v2.1.6 added 30.12.2015
			'dropFilesBrowser': '从浏览器拖动或粘贴文件', // from v2.1 added 30.05.2012
			'dropPasteFiles'  : '拖动或粘贴文件到这里', // from v2.1 added 07.04.2014
