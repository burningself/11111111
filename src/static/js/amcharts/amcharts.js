        ...
        parseDatesDraw: function() {
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    if ("radar" == b.type) {
                        if (h = this.axisWidth - h, 0 > h || h > this.axisWidth) continue } else this.rotate ? "date" == this.type && "middle" == this.gridPosition && (J = -z * this.stepWidth / 2) : "date" == this.type && (h = this.axisWidth - h);
                    f = !1;
    ...
    d.ValueAxis = d.Class({
        ...
        getMinorGridStep: function(a, b) {
            ...
            for (var e = Math.floor(Math.log(Math.abs(a)) * Math.LOG10E), d = 0; d < c.length; d++) {
                ...
                if (!(1 < Math.abs(e - g)))
                    if (1 > a) {
                        if (g = Math.pow(10, -g) * f, g == Math.round(g)) return f } else if (f ==
...
(function() {
    ...
    d.AmChart = d.Class({
        ...
        getTitleHeight: function() { this.drawTitles(!0);
        ...
        addListeners: function() {
            ...
            document.addEventListener ? ("ontouchstart" in document.documentElement && (b.addEventListener("touchstart", function(b) { a.handleTouchStart.call(a, b) }, !0), b.addEventListener("touchmove", function(b) { a.handleMouseMove.call(a, b) }, !0), b.addEventListener("touchend", function(b) {
                a.handleTouchEnd.call(a,
                    b)
            }, !0), a.docfn1 = function(b) { a.handleDocTouchStart.call(a, b) }, a.docfn2 = function(b) { a.handleDocTouchEnd.call(a, b) }, document.addEventListener("touchstart", a.docfn1, !0), document.addEventListener("touchend", a.docfn2, !0)), b.addEventListener("mousedown", function(b) { a.mouseIsOver = !0;
                a.handleMouseMove.call(a, b);
                a.handleMouseDown.call(a, b);
                a.handleDocTouchStart.call(a, b) }, !0), b.addEventListener("mouseover", function(b) { a.handleMouseOver.call(a, b) }, !0), b.addEventListener("mouseout", function(b) {
            ...
            if (this.animations)
                for (a = this.animations.length - 1; 0 <= a; a--) {
                    ...
                    if (e <= c) { b.frame++;
                        ...
                        0 === k ? (this.animations.splice(a, 1), h.node.style[f] = Number(b.to) + b.suffix) : h.node.style[f] = c + b.suffix } else h.node.style[f] = Number(b.to) +
    ...
    d.AmGraph = d.Class({
        ...
        positionLabel: function(a, b, c, e, d) {
            if (e) {
                ...
                if (e && "radar" != f.type)
                    if (q) {
                        if (0 > c || c > this.height) e.remove(), e = null;!this.showAllValueLabels && (0 > b || b > this.width) && (e.remove(), e = null) } else {
        ...
        createSerialGraph: function() {
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < Q) {
                    for (L = Q - 1; - 1 < L; L--)
                        if (G = e[L], v = G.axes[f.id].graphs[b], na = v.values.value, !isNaN(na)) { Q = L;
                            break }
                    if (this.lineColorField)
                        for (L =
                            Q; - 1 < L; L--)
                            if (G = e[L], v = G.axes[f.id].graphs[b], v.lineColor) { this.bulletColorSwitched = this.lineColorSwitched = v.lineColor;
                                break }
                    if (this.fillColorsField)
                        for (L = Q; - 1 < L; L--)
                            if (G = e[L], v = G.axes[f.id].graphs[b], v.fillColors) { this.fillColorsSwitched = v.fillColors;
                                break }
                    if (this.dashLengthField)
                        for (L = Q; - 1 < L; L--)
                            if (G = e[L], v = G.axes[f.id].graphs[b], !isNaN(v.dashLength)) { this.dashLengthSwitched = v.dashLength;
                                break }
                }
                if (ia < e.length - 1)
                        ...
                        case "column":
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (ua) {
                                    ...
                                    if (!I) { "none" == O && (J = t ? (this.end + 1 - L) * C - c : C * L + c); "3d" == O && (t ? (J = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, wa += H * Z, ka += H * Z, v.y += H * Z) : (J = (C - c) * (L + 1) + 1E3 * this.depthCount, Ea += S * Z, la += S * Z, v.y += S * Z));
        ...
        animateColumns: function(a, b) {
            ...
            0 < e && !c.animationPlayed && (c.seqAn ? (a.set.hide(), c.animationArray.push(a), e = setTimeout(function() { c.animate.call(c) },
    ...
    d.ChartCursor = d.Class({
                ...
                if (a.chartData && 0 < a.chartData.length) {
                    ...
                    if (this.zooming) {
                        ...
                        if (this.pan) { this.dispatchPanEvent();
                            return }(this.hZoomEnabled || this.vZoomEnabled) &&
        ...
        dispatchPanEvent: function() {
            if (this.mouseIsDown) {
                ...
                h && (this.hideLines(), this.fire({ type: "panning", chart: this.chart, target: this, deltaX: a, deltaY: b, delta2X: c, delta2Y: e, index: this.index }), this.prevDeltaX = a, this.prevDeltaY = b, this.prevDelta2X = c,
                    this.prevDelta2Y = e)
            }
        },
...
(function() {
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        handleKeys: function(a, b, c) { this.getPercents();
        ...
        handleBgClick: function() {
            ...
            if (!a.resizingRight && !a.resizingLeft) {
                ...
                a.updateOnReleaseOnly ? (a.skipEvent = !1, h.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) : (a.animating = !0, c = Math.round(c), m ? h.animate({ y: c }, e, ">") : h.animate({ x: c }, e, ">"), a.forceClip = !0, clearTimeout(a.forceTO), a.forceTO = setTimeout(function() { a.stopForceClip.call(a) },
                    5E3 * e))
            }
        },
...
(function() {
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parseSerialData: function(a) {
            ...
            if (a)
                if (0 < this.processTimeout) { 1 > this.processCount && (this.processCount = 1);
                    ...
                    for (var c = 0; c < b; c++) this.delayParseSerialData(a, c) } else this.parseCount = 0, this.parsePartSerialData(a,
                    0, a.length, 0);
        ...
        delayParseSerialData: function(a, b) {
            var c = this,
                e = c.processCount;
            setTimeout(function() { c.parsePartSerialData.call(c, a, b * e, (b + 1) * e, b) }, c.processTimeout) },
...
(function() {
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        if (n) { k = [];
            for (w = 0; w < n.length; w++) k.push(d.adjustLuminosity(m.fill, n[w])); "radial" != t || d.isModern || (k = []);
...
(function() {
    ...
    d.AmDObject = d.Class({
        construct: function(a, b) { this.D = b;
            ...
            this.y = this.x = 0;
            this.scale = 1 },
        attr: function(a) { this.R.attr(this, a);
            return this },
        getAttr: function(a) {
            return this.node.getAttribute(a) },
        setAttr: function(a, b) { this.R.setAttr(this, a, b);
            return this },
        ...
        mouseover: function(a) { this.R.addListener(this, "mouseover", a);
            return this },
        mouseout: function(a) { this.R.addListener(this, "mouseout", a);
            return this },
        click: function(a) { this.R.addListener(this, "click", a);
            return this },
        dblclick: function(a) { this.R.addListener(this, "dblclick", a);
            return this },
        mousedown: function(a) { this.R.addListener(this, "mousedown", a);
            return this },
        mouseup: function(a) { this.R.addListener(this, "mouseup", a);
            return this },
        ...
        touchstart: function(a) { this.R.addListener(this, "touchstart", a);
            return this },
        touchend: function(a) { this.R.addListener(this, "touchend", a);
            return this },
        keyup: function(a) { this.R.addListener(this, "keyup", a);
            return this },
        focus: function(a) { this.R.addListener(this, "focus", a);
            return this },
        blur: function(a) { this.R.addListener(this, "blur", a);
            return this },
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            var y = this.entries,
                u, A;
            for (A = 0; A < y.length; A++) { u = y[A].getBBox();
                var z = u.width;
                z > p && (p = z);
                u = u.height;
                u > t && (t = u) }
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                void 0 !== b.tabIndex && (m.setAttr("tabindex", b.tabIndex), m.setAttr("role", "menuitem"),
                    m.keyup(function(c) { 13 == c.keyCode && b.clickMarker(a, c) }));
